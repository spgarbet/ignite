...
costi <- NULL
for(i in 0:9) {
        load(file=paste0("/gpfs23/data/h_imph/gravesj/right/cost_ignite10_SA_clo",i,"_p.rda"))
...
save(sum_costsi,file="/gpfs23/data/h_imph/gravesj/right/icer_ignite10_SA_clo_p.rda")

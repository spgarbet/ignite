...
costi <- NULL
for(i in 0:9) {
        load(file=paste0("/gpfs23/data/h_imph/gravesj/right/cost_ignite10_SA_alt",i,"_v3.rda"))
...
save(sum_costsi,file="/gpfs23/data/h_imph/gravesj/right/icer_ignite10_SA_alt_v3.rda")
